...
"barley":{"display_name":"Barley","img_name":ITEMS_FOLDER + "barley","is_animated":false,"points":10,"place_on":["farmland"],"reaction":REACTIONS.NONE, "num_offset" : [4,1]},
...
"barley_flour":{"display_name":"Barley Flour","img_name":ITEMS_FOLDER + "barley_flour","is_animated":false,"points":20,"place_on":[],"reaction":REACTIONS.NONE, "num_offset" : [6,1]},
...
"barley_bread":{"display_name":"Barley Bread","img_name":ITEMS_FOLDER + "barley_bread","is_animated":false,"points":30,"place_on":[],"reaction":REACTIONS.NONE, "num_offset" : [8,4]},
