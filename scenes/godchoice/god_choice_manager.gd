...
"pineapple":{"title": "Pineapple","img": "res://art/items/pineapple.png","text":"Gain 2 pineapples. Plant on sandy farmland.","type": TYPES.Item,"item unlock":["pineapple"],"unlock literal":true,"reward": "pineapple","amt" : 2},
...
var chained_rewards = null#[ChainedReward.new(["cranberry bush","prickly pear cactus","potato","barrel","mushroom patch", "barrel","barrel"], 0),
